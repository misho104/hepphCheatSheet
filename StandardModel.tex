%#!./compile CheatSheet
%%% Time-Stamp: <2012-07-08 11:10:33 misho>
%%% 文字コードはShift-JISですよね
...
\note{$t$ pole mass is the ``MC mass''. Quark $\overline{\rm{MS}}$ mass at 1\,GeV can be obtained by $\times 1.35$.}
\begin{align*}
...
\text{\small [$\overline{\rm MS}$ (2\,GeV)]}\ \
 u   &: \upd{2.3\pmgosa{0.7}{0.5}}\un{MeV}    &
\text{\small [$\overline{\rm MS}$($m$)]}\ \
 c   &: 1.2{\upd{75(25)}}\un{GeV}             &
\text{\small [pole]}\ \
 c   &: 1.67(7)\un{GeV}
\\
 d   &: \upd{4.8\pmgosa{0.7}{0.3}}\un{MeV}    &
 b   &: 4.1\upd{8(3)}\un{GeV}                 &
 b   &: 4.78(6)\un{GeV}
\\
 s   &: \upd{95\pm5}\un{MeV}                  &
 t   &: 160\pmgosa{5}{4}\un{GeV}              &
