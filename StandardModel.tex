...
%%% Time-Stamp: <2009-06-22 15:50:38>
...
以下では射影演算子$P{{\text{R}}\atop{\text{L}}}:=\dfrac{1\pm\G5}2$をあら
わに書くことにする。
...
とができる。これは場の再定義なのか，$\gU1$ gauge固定なのか。よくわかって
いない。
\end{rightnote}
...
= & \frac{g_2}{\sqrt2}\left(W^+_\mu T^+ + W^-_\mu T^-\right)
   +\left(\frac{ec}sZ^0_\mu+eA_\mu\right)T^3
\end{align}
となる。ここでWeinberg角$\theta\s w$と素電荷$e$を導入した：
\begin{equation}
...
{\quad+\quad}h\bar E y_e L^2\quad +\quad \Hc\\[1zw]
%SU(3) Interactions
\note{$\gSU3$および微分項}&
...
{\quad+\quad}\bar E\left(\ii\slashed\partial\right) E\\[1zw]
\note{$W$ boson}&
...
{\quad+\quad}\bar Q\left[
   ...
   +\left(\frac{ec}{s}T^3-\frac{es}{6c}\right)\slashed Z^0
  \right] Q\\
&{\quad+\quad}\bar U\left(\frac23 e\slashed A-\frac{2es}{3c}\slashed Z\right) U\\
&{\quad+\quad}\bar D\left(-\frac13 e\slashed A+\frac{es}{3c}\slashed Z\right) D\\
&{\quad+\quad}\bar L\left[
    \left(T^3-\frac12\right)e\slashed A
   +\left(\frac{ec}{s}T^3+\frac{es}{2c}\right)\slashed Z^0
  \right] L\\
& 
{\quad+\quad}\bar E\left(-e\slashed A+\frac{es}{c}\slashed Z\right) E\\[.5zw]
\note{湯川項}& % Yukawa
...
{\quad+\quad}\frac1v\bar E M_e \PL L^2h\quad +\quad \Hc\\[1zw]
%SU(3) Interactions
\note{$\gSU3$および微分項}&
...
{\quad+\quad}\bar E\left(\ii\slashed\partial\right) \PR E\\[1zw]
\note{$W$ boson}&
...
{\quad+\quad}\bar Q\left[
   ...
   +\left(\frac{ec}{s}T^3-\frac{es}{6c}\right)\slashed Z^0
  \right]\PL  Q\\
&{\quad+\quad}\bar U\left(\frac23 e\slashed A-\frac{2es}{3c}\slashed Z\right) \PR U\\
&{\quad+\quad}\bar D\left(-\frac13 e\slashed A+\frac{es}{3c}\slashed Z\right) \PR D\\
&{\quad+\quad}\bar L\left[
    \left(T^3-\frac12\right)e\slashed A
   +\left(\frac{ec}{s}T^3+\frac{es}{2c}\right)\slashed Z^0
  \right] \PL L\\
& 
{\quad+\quad}\bar E\left(-e\slashed A+\frac{es}{c}\slashed Z\right) \PR E
\end{align}
となる。
