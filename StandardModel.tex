...
%%% Time-Stamp: <2009-09-21 01:19:20 misho>
...
We will denotes projection operators
$P\genfrac{}{}{0pt}{1}{\text{R}}{\text{L}}:=\dfrac{1\pm\G5}2$ explicitly
in following expressions.

\subsection{Full Lagrangian}
The Lagrangian of the Standard Model, which conserves
$\gSU3\times\gSU2\times\gU1$ gauge symmetry, is
\begin{align}
 \Lag =
& % Gauge Boson Kinetic
 -\frac14B^{\mu\nu}B_{\mu\nu}
...
Higgs場を，真空期待値が$\vev\phi=\frac1{\sqrt2}\binom {0}{v}$
$(v\in\Real)$となるように再定義する。このときHiggs場の4自由度のうち3つは
南部-Goldstone粒子となり，Higgs場は
\begin{equation}
 \phi=\frac1{\sqrt2}\pmat{0\\v+h(x)}\qquad\text{($h(x)$ is a real scalar field.)}
\end{equation}
と書ける。Lagrangianは
\begin{align}
 \Lag\s{Higgs}
...
\end{align}
となる。更に場のnormに注意しながらgauge場を再定義する。
\begin{equation}
...
$\gSU2\s L$ restricts Higgs term as
\begin{equation}
 V(\phi) = -\mu^2(\phi^\dagger\phi) + \lambda|\phi^\dagger\phi|^2.
\end{equation}
Therefore, using the VEV relation $v^2=\mu^2/\lambda$, the potential
after Higgs gets VEV is
\begin{equation}
   V(h) = \frac{\mu^2}{4v^2}h^4 + \frac{\mu^2}v h^3 + \mu^2h^2,
\end{equation}
and Higgs mass is given by $m_h=\sqrt2 \mu$.
...
&
{\quad+\quad}\frac{1}{\sqrt2}h\bar U y_u Q^1
{\quad+\quad}\frac{1}{\sqrt2}h\bar D y_d Q^2
{\quad+\quad}\frac{1}{\sqrt2}h\bar E y_e L^2\quad +\quad \Hc\notag\\[1zw]
%SU(3) Interactions
\note{$\gSU3$および微分項}&
...
\note{湯川項}& % Yukawa
{\quad+\quad}\frac{1}{\sqrt2}v\bar U y_u Q^1
{\quad+\quad}\frac{1}{\sqrt2}v\bar D y_d Q^2
{\quad+\quad}\frac{1}{\sqrt2}v\bar E y_e L^2\quad+\quad \Hc
\end{align}
である。ただしここで
\begin{equation}
