...
%%% Time-Stamp: <2009-07-26 21:44:25>
...
&{\quad+\quad}\bar L\left[
  ...
  \right] L\\
& 
{\quad+\quad}\bar E\left(-|e|\slashed A+\frac{|e|s}{c}\slashed Z\right) E\\[.5zw]
\note{湯川項}& % Yukawa
...
\Paragraph{実験値}
実験値としては，$v=(\sqrt2G\s F)^(-1/2)\sim246\un{GeV}\sim174\sqrt2\un{GeV} $
および$M_w\sim37.3\un{GeV}/\sin\theta\s w$が知られている。
\TODO{拡充}
