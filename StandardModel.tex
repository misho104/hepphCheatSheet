...
%%% Time-Stamp: <2010-11-18 22:58:50 misho>
%%% 文字コードはShift-JISですよね
...
unitary representation. The generators $T_a$ can be taken to be Hermitian, and $V(x) = \exp\left[\ii \alpha^a(x) T^a\right]$ for $\alpha^a(x)\in\Real$;
\begin{align}
