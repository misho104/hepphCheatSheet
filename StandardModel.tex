%#!./compile CheatSheet
%%% Time-Stamp: <2012-07-05 14:21:23 Misho>
%%% 文字コードはShift-JISですよね
...
\note{Quark masses are in $\overline{\rm{MS}}$ scheme, $u, d, s @2\GeV$ and $c, b, t @m$.}
\begin{align*}
 e   &: 0.5109989\upd{28(11)}\un{MeV}         &
 u   &: \upd{2.3\pmgosa{0.7}{0.5}}\un{MeV}    & d&: \upd{4.8\pmgosa{0.7}{0.3}}\un{MeV}\\
\mu  &: 105.6583\upd{715(35)}\un{MeV}         &
 c   &: 1.2{\upd{75(25)}}\un{GeV}             & s&: \upd{95\pm5}\un{MeV}\\
\tau &: 1.77682(16)\un{GeV}                   &
 t   &: 17\upd{3.5(6)(8)}\un{GeV}             & b&: 4.1\upd{8(3)}\un{GeV}
\end{align*}
\begin{align*}
...
\begin{align*}
 \lambda &= 0.22535(65),&
 A&=0.811\pmgosa{0.022}{0.012},&
 \bar\rho&=0.131\pmgosa{0.026}{0.013},&
 \bar\eta&=0.345\pmgosa{0.013}{0.014};&
 J&=(2.96\pmgosa{20}{16})\EE-5
\end{align*}
