...
We use following notations for the Gauge Group $\gSU(3)\times\gSU(2)\times\gU(1)$:
\begin{align*}
...
$\gSU(3)\times\gSU(2)\times\gU(1)$ gauge symmetry, is
\begin{align}
 \Lag =
& % Gauge Boson Kinetic
 -\frac14B^{\mu\nu}B_{\mu\nu}
...
とができる。これは場の再定義なのか，$\gU(1)$ gauge固定なのか。
\TODO{よくわかっていない。}
\end{rightnote}
\newpage
...
$\gSU(2)\s L$ restricts Higgs term as
\begin{equation}
