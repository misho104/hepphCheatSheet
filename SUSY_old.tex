...
\begin{align*}
 ...
 \epsilon^{\alpha\beta}\pdiff{}{\theta^\alpha}\pdiff{}{\theta^\beta}\thth &=
 \pdiff{}{\theta_\alpha}\pdiff{}{\theta^\alpha}\thth = 4\\
 \epsilon_{\alpha\beta}\pdiff{}{\theta_\beta}&=-\pdiff{}{\theta^\alpha}&
 \pdiff{}{\theta_\alpha}\thth&=-2\theta^\alpha&
 \epsilon_{\alpha\beta}\pdiff{}{\theta_\alpha}\pdiff{}{\theta_\beta}\thth &=
 \pdiff{}{\theta^\alpha}\pdiff{}{\theta_\alpha}\thth = -4\\
 \epsilon^{\dalpha\dbeta}\pdiff{}{\btheta^\dbeta}&=-\pdiff{}{\btheta_\dalpha}&
 \pdiff{}{\btheta^\dalpha}\bthth&=-2\btheta_\dalpha&
 \epsilon_{\dalpha\dbeta}\pdiff{}{\btheta_\dalpha}\pdiff{}{\btheta_\dbeta}\bthth &=
 \pdiff{}{\btheta^\dalpha}\pdiff{}{\btheta_\dalpha}\bthth = 4\\
 \epsilon_{\dalpha\dbeta}\pdiff{}{\btheta_\dbeta}&=-\pdiff{}{\btheta^\dalpha}&
 \pdiff{}{\btheta_\dalpha}\bthth&=2\btheta^\dalpha&
 \epsilon^{\dalpha\dbeta}\pdiff{}{\btheta^\dalpha}\pdiff{}{\btheta^\dbeta}\bthth &=
 \pdiff{}{\btheta_\dalpha}\pdiff{}{\btheta^\dalpha}\bthth = -4
\end{align*}
...
\vspace{-1zw}
\begin{align*}
 Q_\alpha       &:=\pdiff{}{\theta^\alpha}+\ii(\Sm\btheta)_\alpha\Pm,&
 D_\alpha       &:=\pdiff{}{\theta^\alpha}-\ii(\Sm\btheta)_\alpha\Pm,&
 y   &:= x - \ii\theta\sigma\btheta,\\
 \bar Q_\dalpha &=-\pdiff{}{\btheta^\dalpha}-\ii(\theta\Sm)_\dalpha\Pm,&
