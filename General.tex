...
%%% Time-Stamp: <2011-03-30 20:43:35 Misho>
...
\mygraphicinc{graphics/collision.eps}{150pt}
\end{minipage}
\begin{minipage}{280pt}
\begin{align*}
 \vnorm p ^2 &= E^2-m_A^2 & \vipro pk &=\vnorm p \vnorm k\cos\theta\\
 \vnorm k ^2 &= E^2-m_B^2\\
 p_1 \cdot p_2&=2E^2-m_A^2 & p_1\cdot k_1  &= p_2 \cdot k_2 = E^2-\vipro pk\\
 k_1 \cdot k_2&=2E^2-m_B^2 & p_1 \cdot k_2 &= p_1 \cdot k_2 = E^2+\vipro pk\\
\end{align*}
\end{minipage}\vskip-20pt
\begin{align*}
&& (p_1+p_2)^2&= (k_1+k_2)^2=4E^2\\
 (p_1-p_2)^2&=-4(E^2-m_A^2)&
 (p_1-k_1)^2&=(p_2-k_2)^2 = -(2E^2-m_A^2-m_B^2)+2\vipro pk\\
 (k_1-k_2)^2&=-4(E^2-m_B^2)&
 (p_1-k_2)^2&=(p_2-k_1)^2 = -(2E^2-m_A^2-m_B^2)-2\vipro pk
\end{align*}
