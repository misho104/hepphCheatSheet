% Time-Stamp: <2025-09-10 14:08:10>
...
\begin{align}
    &\text{[massless: $m\ll T$]}
  &&
  n\w{FD}    = \frac{g L_3^-}{\pi^2}+\Order(x),\quad
  \rho\w{FD} = \frac{3g L_4^-}{\pi^2}+\Order(x^2),\quad
  p\w{FD}    = \frac{g L_4^-}{\pi^2}+\Order(x^2),\\
   &\text{[massless: $m\ll T$; $\mu<0$]}
  &&
  n\w{BE}    = \frac{g L_3^+}{\pi^2}+\Order(x),\quad
  \rho\w{BE} = \frac{3g L_4^+}{\pi^2}+\Order(x^2),\quad
  p\w{BE}    = \frac{g L_4^+}{\pi^2}+\Order(x^2),
\end{align}
