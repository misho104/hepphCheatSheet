...
%%% Time-Stamp: <2010-11-24 01:27:50 misho>
%%% 文字コードはShift-JISですよね
...
-\thth(\Sm\Dm\bar\lambda(y))_\alpha\ \footnotemark
\end{align}\vspace{-24pt}
\footnotetext{Note the signs. $\bar D\bar D\ee^{2gV}D_\alpha\ee^{-2gV}$ is not gauge invariant!
