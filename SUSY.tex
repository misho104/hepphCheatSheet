...
%%% Time-Stamp: <2011-03-16 20:42:09 misho>
...
Here we turn on the coupling constant $g$. When $\Lambda=\lambda(y)+\sqrt2\theta\xi(y)+\thth K(y)$,
\begin{align}
...
\end{align}
\begin{align*}
  \phi&\mapsto \ee^{\ii qg\lambda}\phi&
  C   &\mapsto C+\nIm\lambda&
M+\ii N&\mapsto M+\ii N-K
\\
  \psi&\mapsto \ee^{\ii qg\lambda}\left(\psi+\ii qg\phi\cdot \xi\right)&
  \chi&\mapsto \chi-\tfrac{1}{\sqrt2} \xi&
A_\mu &\mapsto A_\mu+ \Pm(\nRe\lambda)
\\
  F   &\mapsto \ee^{\ii qg\lambda}\left(F+\ii qg\phi K-\ii qg \xi\psi +\frac{(qg)^2}{2}\xi\xi\phi\right)&
...
\end{align}\vspace{-10pt}
\begin{equation}
 W_\alpha^a= -\ii\lambda^a_\alpha(y)
 + \theta_\alpha D^a(y)+\ii(\Smn\theta)_\alpha F^a_{\mu\nu}(y)
-\thth(\Sm\Dm\bar\lambda^a(y))_\alpha
...
\notag\\&&&\qquad+ gD^a(\phi^*T^a\phi)+\sqrt2g\left(\ii\phi^*T^a\psi\lambda-\ii\bar\psi\bar\lambda T^a\phi\right)
\end{align}
...
+ \ii\bar\lambda^a\bSm\Dm\lambda^a
 +\sqrt2g\left(\ii\phi^*T^a\psi\lambda-\ii\bar\psi\bar\lambda T^a\phi\right)
...
\begin{align}
 V^F_{\Hu} &  +\!\! = \sum_a|\mu_iL_i^a|^2 + \Bigl[\mu^*\mu_i\Hd^*L_i +\Hc \Bigr]\\
