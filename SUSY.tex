...
%%% Time-Stamp: <2010-11-24 00:38:34 misho>
%%% 文字コードはShift-JISですよね
...
\Lag&\ni\Phi^\dagger\ee^{2gqV}\Phi;&
 \Phi\mapsto \ee^{\ii q \Lambda}\Phi,\quad& \Phi^\dagger\mapsto \Phi^\dagger\ee^{-\ii q \Lambda^\dagger};& 2gV&\mapsto 2gV-\ii(\Lambda-\Lambda^\dagger)
\end{align}
For gauge transformation $\Lambda=\lambda(y)+\sqrt2\theta\xi(y)+\thth K(y)$,
\begin{align*}
  \phi&\mapsto \ee^{\ii q\lambda}\phi&
  C   &\mapsto C+\tfrac1g\nIm\lambda&
M+\ii N&\mapsto M+\ii N-\tfrac1g K
\\
  \psi&\mapsto \ee^{\ii q\lambda}\left(\psi+\ii q\phi\cdot \xi\right)&
  \chi&\mapsto \chi-\tfrac{1}{\sqrt2g} \xi&
A_\mu &\mapsto A_\mu+\tfrac1g \Pm(\nRe\lambda)
\\
  F   &\mapsto \ee^{\ii q\lambda}\left(F+\ii q\phi K-\ii q \xi\psi +\frac{q^2}{2}\xi\xi\phi\right)&
...
\leadsto F^*F+\Dm\phi^*\Dmu\phi+\ii\bar\psi\bSm\Dm\psi + qg D\phi^*\phi+\ii\sqrt2gq\left(\phi^*\lambda\psi-\phi\bar\lambda\bar\psi\right)
\end{align}
...
\qquad
 \Phi\mapsto \ee^{\ii\tilde\Lambda}\Phi,\quad
 \Phi^\dagger&\mapsto \Phi^\dagger\ee^{-\ii\tilde\Lambda^\dagger};\qquad
\ee^{2g\tilde V} \mapsto \ee^{-\ii \tilde\Lambda^\dagger}\ee^{2g\tilde V}\ee^{\ii\tilde\Lambda}\\
 &\text{with}\ \tilde V:=V^aT^a,\quad
 \tilde \Lambda := \Lambda^aT^a,\quad
 \tilde \Lambda^\dagger := (\Lambda^a)^\dagger T^a\notag
\end{align}
\begin{align}
 2g\tilde V&\mapsto 2g\tilde V-\ii(\tilde\Lambda-\tilde\Lambda^\dagger)-\frac12\left(
...
\begin{align}
\tilde W_\alpha
&= -\frac14\bar D\bar D\ee^{-2g\tilde V}D_\alpha\ee^{2g\tilde V}\\
&= 2g\left[-\ii\lambda_\alpha(y)
 + \theta_\alpha D(y)+\ii(\Smn\theta)_\alpha F_{\mu\nu}(y)
-\thth(\Sm\Dm\bar\lambda(y))_\alpha
\right]
\\
&\qquad\qquad\text{where}\quad
F_{\mu\nu}= \Pm A_\nu-\Pn A_\mu-\ii g[A_\mu,A_\nu],
\quad
\Dm\bar\lambda^\dalpha =\Pm\bar\lambda^\dalpha-\ii g[A_\mu,\bar\lambda^\dalpha]\notag
\end{align}
\TODO{$W$がGauge invであることを確認？っていうか$g$の符号勝手に反転させていいんだっけ。これまでと一貫してるかな。}
\begin{align}
...
\right]\\
&\leadsto 8Kg^2\left[
\frac12D^aD^a+\ii\bar\lambda^a\bSm\Dm\lambda^a
-\frac14F^{\mu\nu\,a}F_{\mu\nu}^a+\frac\ii8\epsilon^{\mu\nu\rho\sigma}F_{\mu\nu}^aF_{\rho\sigma}^a
\right]
\end{align}
